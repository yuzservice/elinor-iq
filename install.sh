#!/usr/bin/env bash
# Installed with:
#   bash -c "$(curl -fsSL https://raw.githubusercontent.com/yuzservice/elinor-iq/main/install.sh)"
set -euo pipefail

RAW_URL="https://raw.githubusercontent.com/yuzservice/elinor-iq/main/install.sh"
REPO_URL="https://github.com/yuzservice/elinor-iq.git"
